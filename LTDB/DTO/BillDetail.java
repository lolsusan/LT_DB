...
public class BillDetail {
    ...
    public BillDetail(int billId, double discount, double totalPrice, int subTotalPrice, int quantity, int productSellingPrice, String productName, String customerName, String date) {
        this.billId = billId;
